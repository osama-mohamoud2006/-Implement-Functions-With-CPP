...
project_dir="E:/projects/c++ course/function implement"
cd "$project_dir" || exit  
...
snapshot_dir="E:/projects/_snapshots_function_implement"
...
git remote add origin "https://github.com/osama-mohamoud2006/-Implement-Functions-With-CPP.git"
